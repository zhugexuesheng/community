...
import com.gxa.springbootmain.mapper.KeFangMapper;
import com.gxa.springbootmain.pojo.KeFang;
import com.gxa.springbootmain.service.KeFangService;
 ...
 * @author zhangyujin
 * @version 1.0
 * @since 2021-02-19 09:16:05
 */
@Service("keFangService")
public class KeFangServiceImpl implements KeFangService {
    ...
    public Map<String, Object> chaXunCount(String mingCheng) {
        ...
        map.put("code", 200);
        map.put("msg", "查询成功");
        map.put("list", this.keFangMapper.chaXunCount(mingCheng));
        return map;
    }
    ...
    public Map<String, Object> chaXunAll() {
        ...
        map.put("code", 200);
        map.put("msg", "查询成功");
        map.put("list", this.keFangMapper.chaXunAll());
        return map;
    }
    ...
    public Map<String, Object> chaXunById(Integer id) {
        ...
        map.put("code", 200);
        map.put("msg", "查询成功");
        map.put("obj", this.keFangMapper.chaXunById(id));
        return map;
    }
    ...
    public Map<String, Object> chaXunFenYe(int page, String mingCheng) {
        // 获取当前表中的总记录
        int tableCount = this.keFangMapper.chaXunCount(mingCheng);
        ...
        map.put("data", this.keFangMapper.chaXunFenYe(xiaBiao, mingCheng));
        return map;
    }
     ...
     */
    @Override
    public Map<String, Object> xinZeng(KeFang keFang) {
        // UUID.randomUUID()  返回内容：asd21321-ewrewrew213213-123213zsad-123asdasd这样的形态
        this.keFangMapper.xinZeng(keFang);
        Map<String, Object> map = new HashMap<>();
     ...
     */
    @Override
    public Map<String, Object> gengXinById(KeFang keFang) {
        this.keFangMapper.gengXinById(keFang);
        Map<String, Object> map = new HashMap<>();
        map.put("code", 200);   // 前端端分离时，前端人员会首先判断code值是否满足200，如果不是200，则提醒用户失败
        map.put("msg", "更新成功");
        return map;
    ...
    public Map<String, Object> shanChuById(String id) {
        this.keFangMapper.shanChuById(id);
        Map<String, Object> map = new HashMap<>();
        map.put("code", 200);   // 前端端分离时，前端人员会首先判断code值是否满足200，如果不是200，则提醒用户失败
        map.put("msg", "删除成功");
        return map;
