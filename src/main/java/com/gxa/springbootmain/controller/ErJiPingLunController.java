...
import com.gxa.springbootmain.service.impl.ErJiPingLunServiceImpl;
 ...
 */
@RestController
@RequestMapping("erJiPingLun")
@Api(value = "(ErJiPingLun)管理", tags = "(ErJiPingLun)管理接口API")
@ApiResponses({
...
public class ErJiPingLunController {
    /**
     * 服务对象
     */
    @Resource
    private ErJiPingLunServiceImpl erJiPingLunServiceImpl;
    ...
    public Map<String, Object> chaXunFenYe(@RequestParam(name = "page") int page, String mingCheng) {
        return this.erJiPingLunServiceImpl.chaXunFenYe(page, mingCheng);
    }
    ...
    public Map<String, Object> chaXunAll() {
        return this.erJiPingLunServiceImpl.chaXunAll();
    }
...
//    })
    public Map<String, Object> shanChuById(@RequestParam("id") String id) {
        return this.erJiPingLunServiceImpl.shanChuById(id);
    }

    /**
     * 通过主键更新单条数据
     *
     * @param erJiPingLun 一个数据库对应的POJO数据对象
     * @return 单条数据
     */
    ...
    public Map<String, Object> gengXinById(@RequestBody @ApiParam(name = "erJiPingLun", value = "pojo模型", required = true) ErJiPingLun erJiPingLun) {
        return this.erJiPingLunServiceImpl.gengXinById(erJiPingLun);
    }
    ...
    public Map<String, Object> xinZeng(@RequestBody @ApiParam(name = "erJiPingLun", value = "pojo模型", required = true) ErJiPingLun erJiPingLun) {
        return this.erJiPingLunServiceImpl.xinZeng(erJiPingLun);
    }

        @RequestMapping(value = "chaXunByPingLunId", method = RequestMethod.POST)
    @ApiOperation(value = "根据一个评论id查询一条**记录的接口",notes = "根据一个评论id查询一条**记录的接口",httpMethod = "POST")
    @ApiImplicitParams({
            @ApiImplicitParam(name = "id",value = "主键",paramType = "query",dataType = "String",required = true),
    })
    public Map<String, Object> chaXunById(@RequestParam("id") String id) {
        return this.erJiPingLunServiceImpl.chaXunByPunLunId(Integer.parseInt(id));
    }
}