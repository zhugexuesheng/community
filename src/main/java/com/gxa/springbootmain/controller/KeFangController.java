...
import com.gxa.springbootmain.service.impl.KeFangServiceImpl;
 ...
 * @author zhangyujin
 * @version 1.0
 * @since 2021-02-19 09:16:06
 */
@RestController
@RequestMapping("keFang")
@Api(value = "(KeFang)管理", tags = "(KeFang)管理接口API")
@ApiResponses({
...
public class KeFangController {
     ...
     */
    @Resource
    private KeFangServiceImpl keFangServiceImpl;
    ...
    public Map<String, Object> chaXunFenYe(@RequestParam(name = "page") int page, String mingCheng) {
        return this.keFangServiceImpl.chaXunFenYe(page, mingCheng);
    }
    ...
    public Map<String, Object> chaXunAll() {
        return this.keFangServiceImpl.chaXunAll();
    }
...
//    })
    public Map<String, Object> shanChuById(@RequestParam("id") String id) {
        return this.keFangServiceImpl.shanChuById(id);
    }

    /**
     * 通过主键更新单条数据
     *
     * @param keFang 一个数据库对应的POJO数据对象
     * @return 单条数据
     */
    ...
    public Map<String, Object> gengXinById(@RequestBody @ApiParam(name = "keFang", value = "pojo模型", required = true) KeFang keFang) {
        return this.keFangServiceImpl.gengXinById(keFang);
    }
    ...
    public Map<String, Object> xinZeng(@RequestBody @ApiParam(name = "keFang", value = "pojo模型", required = true) KeFang keFang) {
        return this.keFangServiceImpl.xinZeng(keFang);
    }
