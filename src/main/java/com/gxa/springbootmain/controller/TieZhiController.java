...
import com.gxa.springbootmain.service.impl.TieZhiServiceImpl;
 ...
 * @author zhangyujin
 * @version 1.0
 * @since 2021-02-15 23:32:24
 */
@RestController
@RequestMapping("tieZhi")
@Api(value = "(TieZhi)管理", tags = "(TieZhi)管理接口API")
@ApiResponses({
...
public class TieZhiController {
    /**
     * 服务对象
     */
    @Resource
    private TieZhiServiceImpl tieZhiServiceImpl;
    ...
    public Map<String, Object> chaXunAll() {
        return this.tieZhiServiceImpl.chaXunAll();
    }
    ...
    public Map<String, Object> gengXinById(@RequestBody @ApiParam(name = "tieZhi", value = "pojo模型", required = true) TieZhi tieZhi) {
        return this.tieZhiServiceImpl.gengXinById(tieZhi);
    }
    ...
    public Map<String, Object> xinZeng(@RequestBody @ApiParam(name = "tieZhi", value = "pojo模型", required = true) TieZhi tieZhi, HttpServletRequest request) {
        return this.tieZhiServiceImpl.xinZeng(tieZhi,request);
    }
